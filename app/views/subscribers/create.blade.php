...
@section('content-header')
    ...
    <section class="content-header">
        <h1> <i class="fa fa-users"></i> Subscriber <small>Control panel</small> </h1>
        <ol class="breadcrumb">
...
@section('content')
    ...
    <section class="content invoice">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">Register Subscriber</h2>
            </div><!-- /.col -->
        </div>
        ...
        <div class="row">
            <div class="col-xs-6">
                <div class="box-footer">
                    {{ Form::submit('Register Subscriber',array('class'=>'btn btn-primary')) }}
                </div>
            </div>
        </div>
        {{ Form::close() }}
